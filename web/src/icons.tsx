...
const PATHS: Record<IconName, string> = {
  ...
  // könyv
  book: 'M11.5 6.2C10 4.9 7.9 4.2 5.3 4.2c-1 0-2 .1-3 .4a1 1 0 0 0-.8 1v12.6a1 1 0 0 0 1.3 1c.8-.2 1.6-.3 2.5-.3 2.3 0 4.1.6 5.2 1.7V6.2zm1 0v14.4c1.1-1.1 2.9-1.7 5.2-1.7.9 0 1.7.1 2.5.3a1 1 0 0 0 1.3-1V5.6a1 1 0 0 0-.8-1c-1-.3-2-.4-3-.4-2.6 0-4.7.7-6.2 2z',
  // hangjegy
